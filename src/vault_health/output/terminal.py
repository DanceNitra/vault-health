...
def print_report(report: DepthReport) -> None:
    ...
    # Depth section
    depth_color = "green" if report.depth_score >= 0.6 else "yellow" if report.depth_score >= 0.3 else "red"
    ...
    table.add_row("  Medium (100-300w)", str(report.files_under_300_words - report.files_under_100_words), "")
    table.add_row("  Deep (>300w)", str(report.total_concepts - report.files_under_300_words), "")
